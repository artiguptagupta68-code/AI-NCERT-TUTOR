...
# 1. Extract the ZIP file (hidden, shipped with app)
# -------------------------------
ZIP_FILE = "ncrt_subject.zip"  # ZIP file in the same folder as app.py
...
# -------------------------------
# 2. Load PDFs and TXT files recursively
# -------------------------------
import zipfile
import os
    ...
    for root, dirs, files in os.walk(folder):
        for file in files:
            if file.endswith(".zip"):
                ...
                extract_all_zips(extract_path)  # recurse
...
if len(texts) == 0:
    raise ValueError("No documents found! Make sure the ZIP file has PDFs or TXT files.")
