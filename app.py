...
if not os.path.exists(EXTRACT_DIR):
    os.makedirs(EXTRACT_DIR)  # safe

# ----------------------------
# Download ZIP from Google Drive (if not exists)
# ----------------------------
