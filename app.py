...
# 1️⃣ Define and create the extraction folder
EXTRACT_DIR = os.path.join(os.getcwd(), "ncert_extracted")
os.makedirs(EXTRACT_DIR, exist_ok=True)
print("Extraction folder:", EXTRACT_DIR)

# 2️⃣ Extract ZIP (example)
ZIP_PATH = "ncert.zip"  # replace with your actual ZIP path
