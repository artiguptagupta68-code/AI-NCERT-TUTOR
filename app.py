...
# CONFIG
# ----------------------------
ZIP_DRIVE_PATH = "/content/drive/MyDrive/ncrt subject.zip"  # update to your Drive path
...
ZIP_URL = "https://drive.google.com/uc?export=download&id=1g1qnn03XSxamjz33ocnwYcZOuJCNW8jj"
ZIP_PATH = "/mnt/data/ncrt_subject.zip"
EXTRACT_DIR = "/mnt/data/ncert_extracted"
...
# Use a folder inside your app or /mnt/data
EXTRACT_DIR = "/mnt/data/ncert_extracted"  # safe writable path

os.makedirs(EXTRACT_DIR, exist_ok=True)    # now this will work
print("Extraction folder:", EXTRACT_DIR)
EXTRACT_DIR = "ncert_extracted"  # folder inside the app
os.makedirs(EXTRACT_DIR, exist_ok=True)
