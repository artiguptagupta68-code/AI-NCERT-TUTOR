...
# CONFIG
# ----------------------------
ZIP_FILE_ID = "1gdiCsGOeIyaDlJ--9qon8VTya3dbjr6G"
ZIP_PATH = "ncert.zip"          # relative path inside app folder
EXTRACT_DIR = "ncert_extracted" # relative folder for extraction
CHUNK_SIZE = 800
CHUNK_OVERLAP = 150
...
if not os.path.exists(ZIP_PATH) or os.path.getsize(ZIP_PATH) == 0:
    ...
    download_url = f"https://drive.google.com/uc?export=download&id={ZIP_FILE_ID}"
