...
# Step 2: Get the path of the uploaded file
# uploaded is a dictionary: {filename: filedata}
zip_path = list(uploaded.keys())[0]  # This gets the first uploaded file name

print("Uploaded file:", zip_path)

# Step 3: Extract the zip file
with zipfile.ZipFile(zip_path, 'r') as zip_ref:
    zip_ref.extractall("extracted_folder")  # You can choose any folder name
